...
export const getNavItems = (userRole: UserRole): NavItem[] => {
    ...
    if (userRole === UserRole.SUPER_ADMIN || userRole === UserRole.MANAGER) {
        items.push({ key: 'dashboard', labelKey: 'nav.dashboard', icon: <DashboardIcon />, path: getDashboardPath(userRole) });
    }
...
export default function Sidebar() {
    ...
    return (
        ...
        >
            <Toolbar sx={{ gap: 1.5, px: 3, justifyContent: 'flex-start' }}>
                <Box component="img" src="/logo.png" alt="Training Platform Logo" sx={{ width: '100%', maxWidth: '130px', objectFit: 'contain', }} />
            </Toolbar>
            <Divider />
